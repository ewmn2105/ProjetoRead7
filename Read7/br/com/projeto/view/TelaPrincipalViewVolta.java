...
import javax.swing.*;
public class TelaPrincipalViewVolta extends JPanel{
		...
		public void defineEventos() {
			b.addMouseListener(new MouseListener() {
			    ...
			    public void mouseEntered(MouseEvent e) {
			    	...
			    	setBackground(new Color(255, 205, 85));
		    ...
		    public void mouseEntered(MouseEvent e) {
		    	...
		    	setBackground(new Color(255, 254, 145));
		    ...
		    public void mouseEntered(MouseEvent e) {
		    	...
		    	setBackground(new Color(133, 197, 245));
